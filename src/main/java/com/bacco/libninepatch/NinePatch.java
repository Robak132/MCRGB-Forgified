...
public final class NinePatch<T> {
    ...
    private <C> void drawTiling(ContextualTextureRenderer<? super T, C> renderer, C context, int width, int height) {
        ...
        float u2 = 1 - cornerU;
        float v2 = 1 - cornerV;
        int tWidth = this.tileWidth == null ? (int) (cornerWidth / cornerU * (u2 - u1)) : this.tileWidth;
        int tHeight = this.tileHeight == null ? (int) (cornerHeight / cornerV * (v2 - v1)) : this.tileHeight;
        ...
        if (hasCorners()) {
            ...
            // vertical
            {
                ...
                int y = cornerHeight;
                renderer.drawTiled(texture, context, 0, y, cornerWidth, regionHeight, cornerWidth, tHeight, 0, v1, cornerU, v2);
                renderer.drawTiled(texture, context, width - cornerWidth, y, cornerWidth, regionHeight, cornerWidth, tHeight, 1 - cornerU, v1, 1, v2);
            }
            ...
            // Horizontal
            {
                ...
                int x = cornerWidth;
                renderer.drawTiled(texture, context, x, 0, regionWidth, cornerHeight, tWidth, cornerHeight, u1, 0, u2, cornerV);
                renderer.drawTiled(texture, context, x, height - cornerHeight, regionWidth, cornerHeight, tWidth, cornerHeight, u1, 1 - cornerV, u2, 1);
            }
        }
    }
