...
public class SyncedGuiDescription extends AbstractContainerMenu implements GuiDescription {
     ...
     * <ol>
     *     <li>Blocks implementing {@code WorldlyContainerHolder}</li>
     *     <li>Block entities implementing {@code WorldlyContainerHolder}</li>
    ...
    public int getTitleColor() {
        return (world.isClientSide && TriState.FALSE.orElse(false)) ? darkTitleColor : titleColor;
    }
