...
import com.bacco.libninepatch.NinePatchBackgroundPainter;
import com.bacco.libninepatch.TextureRegion;
...
public interface BackgroundPainter {
     ...
     * * You can override {@link GuiDescription#addPainters()} to customize the painter yourself.
     *
     * @since 1.5.0
     */
    ...
    static NinePatchBackgroundPainter createNinePatch(Texture texture,
        ...
        TextureRegion<ResourceLocation> region =
            new TextureRegion<>(texture.image(), texture.u1(), texture.v1(), texture.u2(), texture.v2());
