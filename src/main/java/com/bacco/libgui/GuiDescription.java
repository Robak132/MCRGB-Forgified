 ...
 *
 * @see LightweightGuiDescription
 * @see SyncedGuiDescription
 */
public interface GuiDescription {
	WPanel getRootPanel();
	int getTitleColor();
	void setRootPanel(WPanel panel);

	/**
	 * Sets the title color of this GUI.
	 *
	 * <p>The dark-mode title color will also be set by this method.
	 * If the specified color is {@link WLabel#DEFAULT_TEXT_COLOR},
	 * the dark-mode color will be {@link WLabel#DEFAULT_DARKMODE_TEXT_COLOR};
