...
public class WScrollPanel extends WClippedPanel {
     ...
     */
    protected WScrollBar horizontalScrollBar = new WScrollBar(CottonAxis.HORIZONTAL);
    /**
     * The vertical scroll bar of this panel.
     */
    protected WScrollBar verticalScrollBar = new WScrollBar(CottonAxis.VERTICAL);
