...
import com.bacco.mcrrgb.*;
import com.bacco.mcrrgb.gui.*;
...
public class ColourGui extends MCRGBBaseGui {
    ...
    ResourceLocation refreshIdentifier = ResourceLocation.tryBuild("mcrgb", "refresh.png");
    ...
    ResourceLocation settingsIdentifier = ResourceLocation.tryBuild("mcrgb", "settings.png");
    ...
    ResourceLocation wheelIdentifier = ResourceLocation.tryBuild("mcrgb", "wheel.png");
    WColourWheel colourWheel;
    ResourceLocation wheelIconIdentifier = ResourceLocation.tryBuild("mcrgb", "wheel_small.png");
    ...
    ResourceLocation sliderIconIdentifier = ResourceLocation.tryBuild("mcrgb", "sliders.png");
    ...
    public ColourGui(Minecraft client, ColourVector launchColour) {
        ...
        if (ModList.get().isLoaded("cloth_config")) {
            ...
            settingsButton.setOnClick(() -> client.player.displayClientMessage(Component.translatable("warning.mcrgb.noclothconfig"), false));
        }
        updateArmour();
