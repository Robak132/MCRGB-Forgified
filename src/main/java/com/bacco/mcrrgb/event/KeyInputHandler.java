...
public class KeyInputHandler {
    ...
    @Mod.EventBusSubscriber(modid = "mcrgb", bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
    ...
    @Mod.EventBusSubscriber(modid = "mcrgb", bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)
