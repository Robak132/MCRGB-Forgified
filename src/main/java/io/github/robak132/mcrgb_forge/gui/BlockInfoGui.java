...
public class BlockInfoGui extends MCRGBBaseGui {
    ...
    public BlockInfoGui(ItemStack stack, ColourVector launchColour) {
        ...
        backButton.setOnClick(() -> Minecraft.getInstance().setScreen(new ColourScreen(new ColourGui(inputColour))));

        infoBox = new WBlockInfoBox(Direction.Plane.VERTICAL, (IItemBlockColourSaver) stack.getItem(), this);
