...
public class WSmallButton extends WButtonWithTooltip {

    //INCREDIBLY MESSY CODE THAT I AM NOT PROUD OF, BUT IT'S JUST FOR THE 1.20.1 BACKPORT SO IDC.
    ...
    public WSmallButton(@Nullable Icon icon, Component tooltip) {
        super(icon, tooltip);
    }
    ...
    public void paint(GuiGraphics context, int x, int y, int mouseX, int mouseY) {
        ...
        if (getLabel() != null) {
            ...
            ScreenDrawing.drawStringWithShadow(context, getLabel().getVisualOrderText(), alignment, x + xOffset, y + ((10 - 8) / 2), width, color);
        }
    }
