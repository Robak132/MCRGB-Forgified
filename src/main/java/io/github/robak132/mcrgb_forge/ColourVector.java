...
import io.github.robak132.libgui_forge.widget.data.Color;
import lombok.Data;
...
public class ColourVector {
    ...
    public int getHue() {
        ...
        if (chroma == 0) {
            ...
            h = (((this.g - this.b) / chroma) % 6);
        } else if (max == this.g) {
            h = (((this.b - this.r) / chroma) + 2);
        } else if (max == this.b) {
            h = (((this.r - this.g) / chroma) + 4);
        } else {
            h = 0;
        }
        h = h * 60;
    ...
    public int getSatV() {
        return Math.round(new Color.RGB(this.r, this.g, this.b).getHSVSaturation() * 100f);
    }

    public int getVal() {
        return Math.round(100f * (new Color.RGB(this.r, this.g, this.b).value() / 255f));
    }
    ...
    public int getLight() {
        return Math.round(100f * (new Color.RGB(this.r, this.g, this.b).getLightness() / 255f));
    }
