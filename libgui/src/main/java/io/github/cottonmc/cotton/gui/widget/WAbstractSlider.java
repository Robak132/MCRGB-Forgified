...
public abstract class WAbstractSlider extends WWidget {
    ...
    protected final CottonAxis axis;
    protected int min;
    protected int max;
    ...
    protected WAbstractSlider(int min, int max, CottonAxis axis) {
        ...
        this.axis = axis;
        this.value = min;
        this.direction = (axis == CottonAxis.HORIZONTAL) ? Direction.RIGHT : Direction.UP;
    }
    ...
    protected void updateValueCoordRatios() {
        int trackHeight = (axis == CottonAxis.HORIZONTAL ? getWidth() : getHeight()) - getThumbWidth();
    ...
    public enum Direction {
        UP(CottonAxis.VERTICAL, false),
        DOWN(CottonAxis.VERTICAL, true),
        LEFT(CottonAxis.HORIZONTAL, true),
        RIGHT(CottonAxis.HORIZONTAL, false);

        private final CottonAxis axis;
        private final boolean inverted;

        Direction(CottonAxis axis, boolean inverted) {
            this.axis = axis;
