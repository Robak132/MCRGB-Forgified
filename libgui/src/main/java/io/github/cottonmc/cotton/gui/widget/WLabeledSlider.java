...
public class WLabeledSlider extends WAbstractSlider {
    ...
    public WLabeledSlider(int min, int max) {
        this(min, max, CottonAxis.HORIZONTAL);
    }
     ...
     */
    public WLabeledSlider(int min, int max, CottonAxis axis) {
        super(min, max, axis);
    }
     ...
     */
    public WLabeledSlider(int min, int max, CottonAxis axis, @Nullable Component label) {
        this(min, max, axis);
        this.label = label;
    }
    ...
    public void paint(GuiGraphics context, int x, int y, int mouseX, int mouseY) {
        int aWidth = axis == CottonAxis.HORIZONTAL ? width : height;
        int aHeight = axis == CottonAxis.HORIZONTAL ? height : width;
        int rotMouseX;
        if (axis == CottonAxis.HORIZONTAL) {
            rotMouseX = (direction == Direction.LEFT ? width - mouseX : mouseX);
        } else {
            rotMouseX = (direction == Direction.UP ? height - mouseY : mouseY);
        }
        int rotMouseY = axis == CottonAxis.HORIZONTAL ? mouseY : mouseX;
